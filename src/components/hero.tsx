  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-background to-background/50 z-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-primary/20 rounded-full filter blur-3xl animate-blob"></div>
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-accent/20 rounded-full filter blur-3xl animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-secondary/30 rounded-full filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block ">
            ...
            <div className="absolute -bottom-5 -right-5 w-40 h-24 bg-[#F6F7F8] rounded-lg mr-10 flex items-center justify-center text-primary-foreground font-bold text-xl">
