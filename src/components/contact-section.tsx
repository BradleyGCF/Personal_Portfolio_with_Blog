  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "bradley@example.com",
      link: "mailto:bradley@example.com",
    },
    {
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          >
            {contactInfo.map((item, index) => (
              ...
              >
                <div className="mr-4 text-red-600">{item.icon}</div>
                <div>
            ...
            <motion.div variants={itemVariants} className="p-6 bg-background border border-border rounded-xl">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-muted/50 p-2 rounded-full hover:bg-muted transition-colors">
